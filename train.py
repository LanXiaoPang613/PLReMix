...
from utils.train_utils import adjust_lr, init_prototypes, gmm_selection, uniform_warmup, uniform_train, val
...
def main():
    ...
    epoch = 0
    if not args.wo_wandb and wandb.run.resumed:  # resume from checkpoint
        ...
        if epoch < args.warm_up:
            ...
            meta_info.update(
                {'cur_net': 'net1', 'probability': prob2, 'pred_clean': pred_clean2, 'pred_noisy': pred_noisy2,
                 'pred_label': pl2, 'eval_outputs': op2, 'proto_outputs': pt2, 'features': ft2,
            ...
            meta_info.update(
                {'cur_net': 'net2', 'probability': prob1, 'pred_clean': pred_clean1, 'pred_noisy': pred_noisy1,
                 'pred_label': pl1, 'eval_outputs': op1, 'proto_outputs': pt1, 'features': ft1,
